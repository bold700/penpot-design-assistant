<!-- Source: https://m3.material.io/blog/color-fonts-are-here/accessibility -->
<!-- Scraped: 2026-04-20T07:24:26.269Z -->

Posted by
Sarah Daily
, Contributor for Google Fonts
...
- GradientsAll the common CSS gradients are possible, and multiple gradients can be included in a single glyph.
...
#### 1. Reem Kufi Ink and 2. Reem Kufi Fun (Arabic and Latin alphabets)Khaled Hosny (with Latin components by Santiago Orozco)
...
#### 3. Aref Ruqaa Ink (Arabic and Latin alphabets)Abdullah Aref, Khaled Hosny, Hermann Zapf
...
#### 4. Amiri Quran (Arabic and Latin alphabets)Khaled Hosny and Sebastian Kosch
...
#### 5. Cairo Play (Arabic and Latin alphabets)Mohamed Gaber, Accademia di Belle Arti di Urbino (Fine Arts Academy in Urbino, Italy)
...
#### 6. Blaka Ink (Arabic and Latin alphabets)Mohamed Gaber
...
#### 7. Noto Color EmojiGoogle

Last Spring we debuted Noto Emoji, a variable, monochrome version of Noto Color Emoji. And now the chromatic version is available on fonts.google, too. Coinciding with the new Unicode 15.0 Update, this launch includes 21 new characters, bringing us to a total of 3,664 emoji! Thanks to COLRv1, you can customize them all. Go ahead and give the duck a whirl.

#### 8. Bungee Spice (Latin alphabet)David Jonathan Ross
...
#### 9. Nabla (Latin alphabet)Arthur Reinders Folmer, Just van Rossum
