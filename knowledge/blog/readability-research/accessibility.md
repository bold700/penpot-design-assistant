<!-- Source: https://m3.material.io/blog/readability-research/accessibility -->
<!-- Scraped: 2026-04-20T07:53:36.076Z -->
...
Brenton Simpson
, Senior UX Engineer, Material Design
Sedeeq Al-khazraji
, UX Research Associate, Material Design
...
Dependent variables: We measured (1) the time to read a phrase, (2) the time to repeat that phrase, and (3) the accuracy of the repeated message. Phrase accuracy was measured by calculating the Levenshtein distance between the typed and displayed phrase.
