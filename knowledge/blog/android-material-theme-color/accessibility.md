<!-- Source: https://m3.material.io/blog/android-material-theme-color/accessibility -->
<!-- Scraped: 2026-04-20T17:15:46.590Z -->
...
| colorSurface | MDC |
| colorOnSurface | MDC |
| android:colorBackground | Platform |
...
Rather, we suggest taking advantage of ColorStateLists stored in your res/color directory. A CSL can have a single item which includes a color reference and an alpha value, which is perfect for our use case:
xxxxxxxxxx
...
style
name
"ThemeOverlay.App.PrimarySecondary"
parent
item
name
"colorPrimary"
