<!-- Source: https://m3.material.io/blog/readex-pro-legibility-arabic-type-design/accessibility -->
<!-- Scraped: 2026-04-20T07:54:05.814Z -->
...
Amiri has several calligraphic features: 
(1) Fluid structures (2) Thin stroke based on pen movement (3) Thick stroke based on pen movement (4) Softly curved horizontal baseline
...
- Type "Readex Pro” in the search bar
...
- Explanation about the calligraphic and on the typographic versions of Naskh
- Reading Arabic : legibility studies for the Arabic script
- Illiteracy in the Arab world (Unesco)
...
- Partnering to change how the world reads
