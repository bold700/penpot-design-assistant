<!-- Source: https://m3.material.io/blog/m3-expressive-motion-theming/accessibility -->
<!-- Scraped: 2026-04-20T07:39:10.178Z -->
...
Spatial
specs are used to animate changes in an object's position, orientation, size, and shape. The spring overshoots the final value and bounces into place.
Spatial springs applied to movement.
Spatial springs applied to rotation.
Effect
specs are used to animate an object’s properties such as color and opacity, where there shouldn’t be any overshoot.
...
Try out the new motion subsystem in Material 3 Expressive today, and let us know how you like it by tagging us on social media @GoogleDesign. If you find any issues, please file them on the issue tracker.
Happy theming!
